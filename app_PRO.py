...
def extraer_datos_factura(pdf_path):
    ...
    if es_el_corte_ingles:
        ...
        # Potencia (Buscamos la contratada estándar)
        m_pot = re.search(r'Potencia\s*([\d,.]+)\s*kW', texto_completo, re.IGNORECASE)
...
# El resto del código de Streamlit y lógica de negocio se mantiene igual...
# (Sigue exactamente igual que tu código original)
