...
def extraer_datos_factura(pdf_path):
    ...
    if es_el_corte_ingles:
        ...
        # Fecha específica de Energía XXI: "Nº factura: ... emitida el DD de MES de AAAA"
        ...
        # Búsqueda de valores específicos para el Total Real
