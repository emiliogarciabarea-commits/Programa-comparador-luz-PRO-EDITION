...
def extraer_datos_factura(pdf_path):
    ...
    if es_endesa_luz:
        ...
        # 5. Total Real (Suma de "Potencia" en € más "Energia" en €)
        # Buscamos los importes en el resumen de la factura
